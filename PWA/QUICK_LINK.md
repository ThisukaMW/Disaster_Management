...
## ✈️ Airplane Mode Test:

1. **Add app to home screen** (see above)
2. **Launch from home screen** (not browser)
3. **Login** (while online)
4. **Turn on Airplane Mode**
5. **Close app completely**
6. **Re-open app** (still offline)
7. ✅ **App should load!**
8. ✅ **Still logged in!**
9. **Report incident** → Saved locally
10. **Turn off Airplane Mode**
11. ✅ **Data syncs automatically!**
...
- **Launch from home screen** (not Safari/Chrome)
